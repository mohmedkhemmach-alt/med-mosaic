...
// ===== TEMP: FIX OLD ARTICLES CONTENT =====
app.get("/api/fix-articles", async (req, res) => {
  try {
    const articles = [
      {
        id: 1,
        title: "اكتشاف 12 نوعاً جديداً من الأسماك في المحيط الهندي",
        content: "<p>في اكتشاف علمي مثير، تمكّن فريق دولي من العلماء من رصد وتوثيق <strong>12 نوعاً جديداً من الأسماك</strong> في أعماق المحيط الهندي، على عمق يتجاوز 3000 متر تحت سطح الماء.</p><h2>التفاصيل العلمية</h2><p>استخدم الفريق البحثي المؤلف من علماء من 15 دولة غواصات متطورة مجهزة بكاميرات عالية الدقة وأجهزة استشعار متقدمة. استغرقت البعثة 47 يوماً وجمعت آلاف الصور والعينات.</p><h2>الأهمية البيئية</h2><p>يُعزز هذا الاكتشاف الحجج العلمية الداعية إلى حماية المناطق البحرية العميقة من التنقيب عن المعادن. كثير من هذه الأنواع قد تكون مصدراً لمركبات دوائية مستقبلية.</p><h2>الخلاصة</h2><p>يُذكّرنا هذا الاكتشاف بأن المحيطات لا تزال مجهولة إلى حدٍّ كبير، وأن الحفاظ عليها ضرورة علمية وحضارية.</p>",
        excerpt: "فريق دولي يوثّق أنواعاً جديدة في أعماق المحيط الهندي تتجاوز 3000 متر."
      },
      {
        id: 2,
        title: "تلوث البلاستيك في المتوسط: 8 ملايين طن سنوياً",
        content: "<p>تكشف أحدث الدراسات أن <strong>8 ملايين طن</strong> من البلاستيك تصل إلى المحيطات كل عام، مما يهدد النظام البيئي البحري بأكمله وسلسلة الغذاء البحرية.</p><h2>حجم المشكلة</h2><p>يُلوّث البلاستيك المحيطات بشكل متزايد، حيث تمتص الأسماك والكائنات البحرية جزيئاته الدقيقة مما يؤثر على سلسلة الغذاء ويصل في نهاية المطاف إلى الإنسان.</p><h2>التأثير على السواحل المغربية</h2><p>تُعاني السواحل المغربية بشكل خاص من تراكم النفايات البلاستيكية، حيث رصدت دراسات حديثة كميات كبيرة منها على شواطئ أغادير والدار البيضاء والرباط.</p><h2>الحلول المقترحة</h2><p>تدعو منظمات بيئية عديدة إلى تبني سياسات أكثر صرامة لتقليل إنتاج البلاستيك والتحول نحو مواد قابلة للتحلل، فضلاً عن تعزيز حملات تنظيف الشواطئ.</p>",
        excerpt: "أحدث الدراسات تكشف أرقاماً مقلقة عن حجم التلوث البلاستيكي في البحر المتوسط والسواحل المغربية."
      },
      {
        id: 3,
        title: "ارتفاع حرارة المحيطات يُنذر بكارثة مرجانية",
        content: "<p>يُحذّر العلماء من أن ارتفاع درجة حرارة المحيطات بمعدل <strong>2.1 درجة مئوية</strong> خلال العقد الماضي يُهدد الشعاب المرجانية والنظم البيئية البحرية بالانقراض الجماعي.</p><h2>التأثير على الشعاب المرجانية</h2><p>تؤدي الحرارة الزائدة إلى ابيضاض الشعاب المرجانية وموتها، مما يُفقد آلاف الأنواع البحرية موطنها الطبيعي. وتُغطي الشعاب المرجانية أقل من 1% من قاع المحيطات لكنها تؤوي أكثر من 25% من الأنواع البحرية.</p><h2>الوضع في المغرب</h2><p>تشهد السواحل المغربية على البحر المتوسط والمحيط الأطلسي تأثيرات واضحة لارتفاع الحرارة، مع تراجع ملحوظ في أعداد بعض الأنواع البحرية خلال السنوات الأخيرة.</p><h2>الحلول والتوصيات</h2><p>يدعو العلماء إلى خفض انبعاثات الكربون بشكل عاجل وإنشاء محميات بحرية موسّعة لحماية النظم البيئية الهشة وإعطائها فرصة للتعافي.</p>",
        excerpt: "العلماء يُحذّرون من تأثير ارتفاع حرارة المحيطات على الشعاب المرجانية والتنوع البيولوجي البحري."
      }
    ];
    ...
    for (const a of articles) {
      await pool.execute(
        ...
        [a.title, a.content, a.excerpt, a.id]
      );
    }
    res.json({ ok: true, message: "Articles updated successfully!", count: articles.length });
  } catch(e) {
